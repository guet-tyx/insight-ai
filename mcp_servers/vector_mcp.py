...
from app.services.ingest_service import COLLECTION, get_milvus_client  # noqa: E402
from app.services.retrieval_service import search as hybrid_search  # noqa: E402
...
async def store_chunk(doc_id: str, text: str, metadata: dict | None = None) -> dict:
    ...
    """
    try:
        from app.services.ingest_service import EMBED_BATCH_SIZE, _embedder
